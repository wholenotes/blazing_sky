...
class CloudsControllerTest < ActionController::TestCase
  ...
  test "should create cloud" do
    assert_difference('Cloud.count') do
      post :create, cloud: { date_observed: @cloud.date_observed, genus: @cloud.genus, species: @cloud.species }
    end
  ...
  test "should update cloud" do
    put :update, id: @cloud, cloud: { date_observed: @cloud.date_observed, genus: @cloud.genus, species: @cloud.species }
    assert_redirected_to cloud_path(assigns(:cloud))
  end
